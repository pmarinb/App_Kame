...
class Tipo_Rodamiento(models.Model):
    ...
    TIPO = models.CharField(max_length=100, default="N/A", blank=True)
...
class Rodamiento(models.Model):
    ...
    D_INT_A = models.DecimalField(
        max_digits=15, decimal_places=5, default=0, blank=True)
    ...
    D_ESP_T = models.DecimalField(
        max_digits=15, decimal_places=5, default=0, blank=True)
    N_PARTE_1 = models.CharField(max_length=100, default="N/A", blank=True)
    N_PARTE_2 = models.CharField(max_length=100, default="N/A",blank=True)
    FK_TIPO_ROD = models.ForeignKey(
        'Tipo_Rodamiento', on_delete=models.ProtectedError, blank=True, null=True)
    DESCRIPCION = models.CharField(max_length=1000, default="N/A",blank=True)


class Equivalente(models.Model):
    FK_RODAMIENTO = models.ForeignKey(
        'Rodamiento', on_delete=models.CASCADE, null=False)
    N_ROD = models.CharField(max_length=100, default="N/A",blank=True)
    MARCA = models.CharField(max_length=100, default="N/A",blank=True)
